...
colors:
  ...
  warm-muted: "oklch(0.252 0 0)"
  warm-muted-text: "oklch(0.7699 0 0)"
  warm-cream: "oklch(0.9821 0 0)"
  warm-paper: "oklch(0.9911 0 0)"
  dark-border: "oklch(1 0 0 / 0.14)"
  light-border: "oklch(0.86 0.005 48.717)"
  foreground-dark: "oklch(0.9491 0 0)"
  foreground-light: "oklch(0.2435 0 0)"
