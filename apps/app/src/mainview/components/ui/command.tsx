  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup
        ...
        "
      >
        <CommandPrimitive.Input data-slot="input-group-control" className={cn(`
              w-full text-xs/relaxed outline-none
...
function CommandList({
  ...
  return <CommandPrimitive.List data-slot="command-list" className={cn(`
...
function CommandGroup({
  ...
  return <CommandPrimitive.Group data-slot="command-group" className={cn(`
          ...
          **:[[cmdk-group-heading]]:px-2.5 **:[[cmdk-group-heading]]:py-1.5
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item data-slot="command-item" className={cn(`
          group/command-item relative flex min-h-7 cursor-default items-center
          gap-2 rounded-md px-2.5 py-1.5 text-xs/relaxed transition-all
...
function CommandShortcut({
  ...
  return <span data-slot="command-shortcut" className={cn(`
