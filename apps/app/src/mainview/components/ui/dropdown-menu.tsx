  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(`
          ...
          items-center gap-2 rounded-md px-2 py-1 text-xs/relaxed outline-hidden
          select-none
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent data-slot="dropdown-menu-sub-content" className={cn(`
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(`
          ...
          py-1.5 pr-8 pl-2 text-xs outline-hidden select-none
          focus:bg-accent focus:text-accent-foreground
...
function DropdownMenuShortcut({
  ...
  return <span data-slot="dropdown-menu-shortcut" className={cn(`
