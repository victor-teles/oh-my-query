  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(`
          ...
          border-input bg-input/20 px-2 py-1.5 text-xs/relaxed whitespace-nowrap
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(`
              ...
              w-(--anchor-width) min-w-32 origin-(--transform-origin)
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item data-slot="select-item" className={cn(`
          ...
          rounded-md px-2 py-1 text-xs/relaxed transition-all duration-150
          ease-out outline-none select-none
