...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root data-slot="avatar" data-size={size} className={cn(`
...
function AvatarFallback({
  ...
  return <AvatarPrimitive.Fallback data-slot="avatar-fallback" className={cn(`
...
function AvatarBadge({ className, ...props }: React.ComponentProps<"span">) {
  return <span data-slot="avatar-badge" className={cn(`
...
function AvatarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return <div data-slot="avatar-group" className={cn(`
...
function AvatarGroupCount({
  ...
  return <div data-slot="avatar-group-count" className={cn(`
          relative flex size-8 shrink-0 items-center justify-center rounded-full
          bg-muted text-xs/relaxed text-muted-foreground ring-2 ring-background
