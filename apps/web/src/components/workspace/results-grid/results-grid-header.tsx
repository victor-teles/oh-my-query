  ...
  return (
    ...
    >
      <div
        ...
        className="group/header relative flex shrink-0 items-center gap-1 bg-background px-2 text-foreground data-[last-left-pin]:shadow-[inset_-1px_0_0_0_var(--color-border)] data-[first-right-pin]:shadow-[inset_1px_0_0_0_var(--color-border)] data-[pinned]:z-30 group-data-[scrolled-x]/grid:data-[last-left-pin]:shadow-[4px_0_6px_-2px_rgb(0_0_0/0.25),inset_-1px_0_0_0_var(--color-border)]"
        role="columnheader"
...
export const ResultsGridHeader = ({
  ...
  <>
    {table.getHeaderGroups().map((headerGroup) => (
      <div
        aria-rowindex={1}
        className="sticky top-0 z-20 flex border-border/60 border-b bg-background"
        key={headerGroup.id}
        role="row"
